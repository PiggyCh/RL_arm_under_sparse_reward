...
def get_pick_demo(env, env_params):
    savetime = 0
    obs_total, ag_total, g_total, acts_total, hands_total, info_total, next_obs_total, next_ag_total, r_total = [], [], [], [], [], [], [], [], []
    for epoch in range(100000):
        if savetime >= demo_num:
            break
        mb_obs, mb_ag, mb_g, mb_acts, mb_hands, mb_info, mb_next_obs, mb_next_ag, mb_r = [], [], [], [], [], [], [], [], []
        # reset the rollouts
        ep_obs, ep_ag, ep_g, ep_acts, ep_hands, ep_info, ep_next_obs, ep_next_ag, ep_r = [], [], [], [], [], [], [], [], []
    ...
    np.savez_compressed(file, acts=acts, hands=hands, obs=obs, info=info, g=g,
